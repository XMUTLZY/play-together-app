package com.example.xmut_news.view;
...
public class PublishDialog extends Dialog {
    ...
    private void goinDia() {
        ...
        //底部按钮动画执行过之后把发布设置为可见
        mPublishDialogFabu.setAnimation(AnimationUtils.loadAnimation(mContext, R.anim.main_shoot_in));
        ...
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                mPublishDialogHuishou.setAnimation(AnimationUtils.loadAnimation(mContext, R.anim.main_shoot_in));
            }
        }, 100);
        ...
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                mPublishDialogPinggu.setAnimation(AnimationUtils.loadAnimation(mContext, R.anim.main_shoot_in));
    ...
    public void outDia() {
        ...
        mPublishDialogFabu.setAnimation(AnimationUtils.loadAnimation(mContext, R.anim.main_shoot_out));
        //然后设置发布从上向下平移动画
        mPublishDialogFabu.setVisibility(View.INVISIBLE);
        //将其设置为不可见
        mHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                mPublishDialogHuishou.setAnimation(AnimationUtils.loadAnimation(mContext, R.anim.main_shoot_out));
                mPublishDialogHuishou.setVisibility(View.INVISIBLE);
            }
        }, 100);
        ...
        mHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                mPublishDialogPinggu.setAnimation(AnimationUtils.loadAnimation(mContext, R.anim.main_shoot_out));
                mPublishDialogPinggu.setVisibility(View.INVISIBLE);
            }
        }, 150);
    }
